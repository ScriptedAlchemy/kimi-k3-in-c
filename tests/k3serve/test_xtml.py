...
"""
test_xtml.py — is k3serve/xtml.py really K3's encoder?
...
upstream raises them, and that content carrying `<|open|>` stays text.
    ...
    python3 tests/k3serve/test_xtml.py
    K3_DIR=/Volumes/WasteDisk/k3 python3 tests/k3serve/test_xtml.py
"""
...
from tests.k3serve.corpus import CASES
...
class TestAgainstUpstream(unittest.TestCase):
    """k3serve/xtml.py against the encoder that shipped with the weights."""
